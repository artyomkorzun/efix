...
public final class TimestampParser {
    ...
    public long getUTCTimestampValue (Buffer buffer, int offset, int length) {
    ...
    public long getUTCDateOnly(Buffer buffer, int offset, int length) {
        //TODO: Validate ':' characters
    ...
    public int getUTCDateOnly2(Buffer buffer, int offset, int length) {
        if (length != 8)
