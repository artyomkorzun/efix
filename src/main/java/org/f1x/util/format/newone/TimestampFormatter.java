...
public class TimestampFormatter {
    ...
    protected static final int TIMESTAMP_LENGTH = DateFormatter.DATE_LENGTH + 1 + TimeFormatter.TIME_LENGTH;

    protected static final int DASH_OFFSET = DateFormatter.DATE_LENGTH;
