...
public final class CharSequenceFormatter {
    ...
    public static int format(CharSequence source, MutableBuffer buffer, int offset) {
     ...
     */
    public static int format(CharSequence source, int srcStart, int srcEnd, MutableBuffer buffer, int offset) {
