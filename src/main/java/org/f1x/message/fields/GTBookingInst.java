...
public enum GTBookingInst implements org.f1x.message.types.ByteEnum {
    ...
    public static GTBookingInst parse(String s) {
        switch (s) {
            case "0":
                return BOOK_OUT_ALL_TRADES_ON_DAY_OF_EXECUTION;
            case "1":
                return ACCUMULATE_EXECUTIONS_UNTIL_ORDER_IS_FILLED_OR_EXPIRES;
            case "2":
                return ACCUMULATE_UNTIL_VERBALLY_NOTIFIED_OTHERWISE;
        }
        return null;
    }
