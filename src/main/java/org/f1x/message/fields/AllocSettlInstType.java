...
public enum AllocSettlInstType implements org.f1x.message.types.ByteEnum {
    ...
    public static AllocSettlInstType parse(String s) {
        switch (s) {
            case "0":
                return USE_DEFAULT_INSTRUCTIONS;
            case "1":
                return DERIVE_FROM_PARAMETERS_PROVIDED;
            case "2":
                return FULL_DETAILS_PROVIDED;
            case "3":
                return SSI_DB_IDS_PROVIDED;
            case "4":
                return PHONE_FOR_INSTRUCTIONS;
        }
        return null;
    }
