...
public enum ExecRestatementReason implements org.f1x.message.types.IntEnum {
    ...
    public static ExecRestatementReason parse(String s) {
        switch (s) {
            ...
            case "6":
                return CANCEL_ON_TRADING_HALT;
            case "7":
                return CANCEL_ON_SYSTEM_FAILURE;
            case "8":
                return MARKET_OPTION;
            case "9":
                return CANCELED_NOT_BEST;
            case "10":
