...
public enum PosReqResult implements org.f1x.message.types.IntEnum {
    VALID_REQUEST(0),
    ...
    public static PosReqResult parse(String s) {
        switch (s) {
            ...
            case "2":
                return NO_POSITIONS_FOUND_THAT_MATCH_CRITERIA;
            case "3":
                return NOT_AUTHORIZED_TO_REQUEST_POSITIONS;
            case "4":
                return REQUEST_FOR_POSITION_NOT_SUPPORTED;
            case "99":
                return OTHER;
        }
        return null;
