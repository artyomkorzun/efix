...
public enum CollAsgnRejectReason implements org.f1x.message.types.IntEnum {
    UNKNOWN_DEAL(0),
    ...
    public static CollAsgnRejectReason parse(String s) {
        switch (s) {
            case "0":
                return UNKNOWN_DEAL;
            case "1":
                return UNKNOWN_OR_INVALID_INSTRUMENT;
            case "2":
                return UNAUTHORIZED_TRANSACTION;
            case "3":
                return INSUFFICIENT_COLLATERAL;
            case "4":
                return INVALID_TYPE_OF_COLLATERAL;
            case "5":
                return EXCESSIVE_SUBSTITUTION;
            case "99":
                return OTHER;
        }
        return null;
