...
public enum OrdRejReason implements org.f1x.message.types.IntEnum {
    ...
    public static OrdRejReason parse(String s) {
        switch (s) {
            ...
            case "7":
                return DUPLICATE_OF_A_VERBALLY_COMMUNICATED_ORDER;
            case "8":
                return STALE_ORDER;
            case "9":
                return TRADE_ALONG_REQUIRED;
            case "10":
                return INVALID_INVESTOR_ID;
            case "11":
                return UNSUPPORTED_ORDER_CHARACTERISTIC;
            case "12":
                return SURVEILLENCE_OPTION;
            case "13":
