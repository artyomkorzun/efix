...
public enum ClearingFeeIndicator implements org.f1x.message.types.StringEnum {
    CBOE_MEMBER("B"),
    ...
    public static ClearingFeeIndicator parse(String s) {
        switch (s) {
            case "B":
                return CBOE_MEMBER;
            case "C":
                return NON_MEMBER_AND_CUSTOMER;
            case "E":
                return EQUITY_MEMBER_AND_CLEARING_MEMBER;
            case "F":
                return FULL_AND_ASSOCIATE_MEMBER_TRADING_FOR_OWN_ACCOUNT_AND_AS_FLOOR_BROKERS;
            case "H":
                return FIRMS_106H_AND_106J;
            case "I":
                return GIM_IDEM_AND_COM_MEMBERSHIP_INTEREST_HOLDERS;
            case "L":
                return LESSEE_AND_106F_EMPLOYEES;
            case "M":
                return ALL_OTHER_OWNERSHIP_TYPES;
        }
        return null;
    }
