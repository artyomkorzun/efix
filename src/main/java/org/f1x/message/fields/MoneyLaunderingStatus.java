...
public enum MoneyLaunderingStatus implements org.f1x.message.types.ByteEnum {
    PASSED((byte) 'Y'),
    NOT_CHECKED((byte) 'N'),
    ...
    public static MoneyLaunderingStatus parse(String s) {
        switch (s) {
            ...
            case "N":
                return NOT_CHECKED;
            case "1":
                return EXEMPT_BELOW_THE_LIMIT;
            case "2":
                return EXEMPT_CLIENT_MONEY_TYPE_EXEMPTION;
            case "3":
                return EXEMPT_AUTHORISED_CREDIT_OR_FINANCIAL_INSTITUTION;
        }
        return null;
    }
