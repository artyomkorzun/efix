...
public enum PartyIDSource implements org.f1x.message.types.ByteEnum {
    BIC((byte) 'B'),
    ...
    public static PartyIDSource parse(String s) {
        switch (s) {
            case "B":
                return BIC;
            case "C":
                return GENERALLY_ACCEPTED_MARKET_PARTICIPANT_IDENTIFIER;
            case "D":
                return PROPRIETARY_CUSTOM_CODE;
            case "E":
                return ISO_COUNTRY_CODE;
            case "F":
                return SETTLEMENT_ENTITY_LOCATION;
            case "G":
                return MIC;
            case "H":
                return CSD_PARTICIPANT_MEMBER_CODE;
            case "1":
                return KOREAN_INVESTOR_ID;
            case "2":
                return TAIWANESE_QUALIFIED_FOREIGN_INVESTOR_ID_QFII_FID;
            case "3":
                return TAIWANESE_TRADING_ACCOUNT;
            case "4":
                return MALAYSIAN_CENTRAL_DEPOSITORY_NUMBER;
            case "5":
                return CHINESE_B_SHARE;
            case "6":
                return UK_NATIONAL_INSURANCE_OR_PENSION_NUMBER;
            case "7":
                return US_SOCIAL_SECURITY_NUMBER;
            case "8":
                return US_EMPLOYER_IDENTIFICATION_NUMBER;
            case "9":
                return AUSTRALIAN_BUSINESS_NUMBER;
            case "A":
                return AUSTRALIAN_TAX_FILE_NUMBER;
            case "I":
                return DIRECTED_BROKER;
        }
        return null;
    }
