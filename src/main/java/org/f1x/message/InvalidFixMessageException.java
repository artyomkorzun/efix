...
public final class InvalidFixMessageException extends Exception {
    ...
    public static final InvalidFixMessageException EMPTY_MESSAGE = new InvalidFixMessageException("Message has no data");
    public static final InvalidFixMessageException BAD_FIRST_TAG = new InvalidFixMessageException("Message does not begin with BeginString(8) tag.");
    public static final InvalidFixMessageException INVALID_BEGIN_STRING = new InvalidFixMessageException("Message tag BeginString(8) has unexpected value. Wrong FIX version?");
    public static final InvalidFixMessageException MISSING_BODY_LENGTH = new InvalidFixMessageException("Message has BodyLength(9) tag");
    public static final InvalidFixMessageException BAD_BODY_LENGTH = new InvalidFixMessageException("Message BodyLength(9) is invalid");
    public static final InvalidFixMessageException MISSING_MSG_TYPE = new InvalidFixMessageException("Message has no MsgType(35) tag");
    public static final InvalidFixMessageException MESSAGE_TOO_LARGE = new InvalidFixMessageException("Message is too large");
    ...
    public static final InvalidFixMessageException EXPECTING_LOGON_MESSAGE = new InvalidFixMessageException("Application-level connection is not yet established (Unfinished LOGON)");
