...
public class IOIQualifier {
    ...
    public static final byte ALL_OR_NONE = 'A';
    public static final byte MARKET_ON_CLOSE = 'B';
    public static final byte AT_THE_CLOSE = 'C';
    public static final byte VWAP = 'D';
    ...
    public static final byte AT_THE_MARKET = 'Q';
