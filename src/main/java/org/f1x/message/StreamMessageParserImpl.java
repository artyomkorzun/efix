...
import org.f1x.message.parser.StreamMessageParser;
import org.f1x.util.ByteSequence;
import org.f1x.util.MutableInt;
import org.f1x.util.buffer.Buffer;
import org.f1x.util.parse.newOne.*;

import static org.f1x.message.FieldUtil.FIELD_SEPARATOR;
import static org.f1x.message.FieldUtil.TAG_VALUE_SEPARATOR;

public class StreamMessageParserImpl implements StreamMessageParser {
    ...
    @Override
    public StreamMessageParser wrap(Buffer buffer, int offset, int length) {
        this.buffer = buffer;
    ...
    @Override
    public StreamMessageParser reset() {
        offset.value(start);
        return this;
    }
