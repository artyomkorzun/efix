...
import static org.efix.util.BitUtil.nextPowerOfTwo;
...
public class NioSelectedKeySet extends AbstractSet<SelectionKey>
{
    ...
    {
        keys = new SelectionKey[nextPowerOfTwo(initialCapacity)];
    }
     ...
     *
     * @param function to apply to each {@link SelectionKey}
    ...
    private void ensureCapacity(final int requiredCapacity)
    {
        ...
        {
            keys = Arrays.copyOf(keys, nextPowerOfTwo(requiredCapacity));
        }
    }
}
