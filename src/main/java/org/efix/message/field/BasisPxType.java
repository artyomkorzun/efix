...
public class BasisPxType {
    ...
    public static final byte CLOSING_PRICE_AT_MORNING_SESSION = '2';
    ...
    public static final byte VWAP_THROUGH_A_DAY_EXCEPT_YORI = '9';
    public static final byte VWAP_THROUGH_A_MORNING_SESSION_EXCEPT_YORI = 'A';
    public static final byte VWAP_THROUGH_AN_AFTERNOON_SESSION_EXCEPT_YORI = 'B';
